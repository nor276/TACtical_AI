...
namespace TAC_AI.AI
{
    ...
    internal static class EWeapSetup
    {
        ...
        public static EAttackMode GetAttackStrat(Tank tank, TankAIHelper helper)
        {
            ...
            // misclassified !Forwards -> EAttackMode.Circle -> it broadsided and its fixed guns never bore on the
            // target. All-turret techs (no fixed weapons) stay !Forwards and correctly circle.
